...
- A final summary block shows module, task, plan, run, skip, warning, and error counts.
...
- Dotfiles repo checkout/config, zsh framework pulls, and tmux server restarts now skip cleanly when nothing needs to change.
