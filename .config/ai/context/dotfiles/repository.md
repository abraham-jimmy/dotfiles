...
- Sparse checkout uses cone-mode path lists under `$HOME/.dotfiles_setup/profiles`; private root shell startup files are generated locally and excluded from the bare repository.
