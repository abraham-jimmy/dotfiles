...
Small approved changes may join the task commit. For a material replan, show only the planning diff and message, then ask whether to commit named `.ai-nova/` planning artifacts separately. Never stage implementation code through this command.
