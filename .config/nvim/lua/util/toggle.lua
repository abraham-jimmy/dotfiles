...
function M.line_numbers()
  ...
  notify(
    (enabled and "Enabled" or "Disabled") .. " line numbers",
...
function M.diagnostics()
  ...
  notify(
    (not enabled and "Enabled" or "Disabled") .. " diagnostics",
...
function M.inline_diagnostics()
  ...
  notify(
    (not enabled and "Enabled" or "Disabled") .. " inline diagnostics",
    not enabled and vim.log.levels.INFO or vim.log.levels.WARN
  )
end
...
function M.inlay_hints()
  ...
  notify(
    (not enabled and "Enabled" or "Disabled") .. " inlay hints",
    not enabled and vim.log.levels.INFO or vim.log.levels.WARN
  )
end
...
function M.autoformat()
  ...
  notify(
    (vim.g.autoformat_enabled and "Enabled" or "Disabled") .. " autoformat",
    vim.g.autoformat_enabled and vim.log.levels.INFO or vim.log.levels.WARN
  )
end
...
function M.indent_scope()
  ...
  notify(
    (enabled and "Enabled" or "Disabled") .. " indent scope",
    enabled and vim.log.levels.INFO or vim.log.levels.WARN
  )
end
